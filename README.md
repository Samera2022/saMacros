...
<p align="center">
  ...
  <br>
  <a href="https://saMacros.pages.dev"><img src="https://img.shields.io/badge/Website-saMacros.pages.dev-0078d4?logo=cloudflare-pages&logoColor=white" alt="Official Website"></a>
</p>
...
Visit **[saMacros.pages.dev](https://saMacros.pages.dev)** for:
- 📖 Detailed developer documentation and beginner tutorials
...
*   **[saMacros.pages.dev](https://saMacros.pages.dev)** — The official project website with in-depth development docs, beginner tutorials, feature highlights, subscription & activation, and downloads.
*   For up-to-date documents, you can also refer to [Samera2022/saMacros | DeepWiki](https://deepwiki.com/Samera2022/saMacros) or just click the badge at the top of the article. The website weekly updates this project's docs and provides a "Refresh this wiki" with "Enter email to refresh" button to force update the docs if it hasn't indexed yet.
